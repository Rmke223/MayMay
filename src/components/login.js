...
function Login({ bearer, setBearer, setCurrentPage, setUserEmail, userEmail, setUserPassword, userPassword, userInfo, setUserInfo }) {
    ...
    useEffect(()=>{
        if(userInfo !== "")
        {userInfo && setCurrentPage(prevpage=>prevpage = 'templates')}
    },[userInfo])
